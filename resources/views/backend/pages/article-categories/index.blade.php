...
@section('content')
    <!-- header area start -->
    <x-admin.header pageTitle="Article Categories" currentPage="Article Categories"></x-admin.header>
    <!-- header area end -->
            ...
            <div class="col-lg-12 mt-5">
                <div class="row justify-content-between">
                    ...
                    <div class="col-auto ml-0">
                        ...
                        <x-outline-button color="primary" href="{{route('article-categories.create')}}">Add Category</x-outline-button>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
