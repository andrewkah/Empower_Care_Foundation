                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <x-form has-files :action="route('teams.store')">
                                     ...
                                     <div class="row">
                                        <div class="form-group col-sm-6">
                                            <x-input.label for="phone">Phone</x-input.label>
                                                <x-input.text type="text" class="form-control @error('phone') error-message @enderror" id="phone" :value="old('phone')" name="phone" placeholder="Phone"
                                                     />
                                                @error('phone')
                                        ...
                                        <div class="form-group col-sm-6">
                                            <x-input.label for="position">Position</x-input.label>
                                                <x-input.text type="text" class="form-control @error('position') error-message @enderror" id="position" :value="old('position')" name="position" placeholder="Position"
                                                     />
                                                @error('position')
