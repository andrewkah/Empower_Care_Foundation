...
/* Caption input field */
.image-caption, .new-image-caption {
    display: block;
    width: 90%;
    margin: 5px auto;
    padding: 5px;
...
.remove-image:hover, .remove-new-image:hover {
      ...
      <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body card-block">
              <form method="post" action="{{route('program.update_gallery',$album->id)}}" enctype="multipart/form-data">
                @csrf 
                @method('PUT')
               ...
               @foreach ($album->other_photos as $index => $image)
                    <div class=" image-preview row">
                        ...
                        <img src="{{Storage::url($image) }}" alt="Image"  height="75" width="75">
                        </div>
                        <div class="col-4"><input type="text" name="captions[{{ $index }}]" value="{{ old('captions.' . $index, $album->captions[$index] ?? '') }}" class="image-caption form-control" placeholder="Enter caption"></div>
                        <div class="col-1"><button type="button" class="remove-image btn btn-sm btn-danger" data-index="{{ $index }}">X</button></div>
                ...
                <div id="new-images-section">
                    ...
                    <button type="button" class="btn btn-sm btn-info" id="add-new-images">Add Image with Caption</button>
                </div>
