                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <x-form has-files :action="route('partners.store')">
                                    <div class="form-group">
                                        <x-input.label for="name">Name</x-input.label>
                                            <x-input.text type="text" class="form-control @error('name') error-message @enderror" id="name" :value="old('name')" name="name" placeholder="Name"
                                                required />
                                            @error('name')
                                     ...
                                     <div class="row">
                                        <div class="form-group col-sm-6">
                                            <x-input.label for="address">Address</x-input.label>
                                                <x-input.text type="text" class="form-control @error('address') error-message @enderror" id="address" :value="old('address')" name="address" placeholder="Address"
                                                    required />
                                                @error('address')
                                        ...
                                        <div class="form-group col-sm-6">
                                            <x-input.label for="website">Website</x-input.label>
                                                <x-input.text type="text" class="form-control @error('website') error-message @enderror" id="website" :value="old('website')" name="website" placeholder="Website"
                                                    required />
                                                @error('website')
