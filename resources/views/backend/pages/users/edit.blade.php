                                ...
                                <x-form has-files :action="route('users.store')">
                                    <div class="form-group">
                                        <x-input.label for="name">Name</x-input.label>
                                            <x-input.text type="text" class="form-control" id="name" :value="{{ old('name',$data->name)}}" name="name" placeholder="Name"
                                                required />
                                            @error('name')
                                    ...
                                    <div class="form-group">
                                        <x-input.label for="email">Email Address</x-input.label>
                                            <x-input.text type="text" class="form-control" id="email" :value="{{ old('email',$data->email)}}" name="email" placeholder="someone@example.com"
                                                required />
                                            @error('email')
