                                ...
                                <x-form has-files :action="route('articles.update')" method="PUT">
                                    <div class="form-group">
                                        ...
                                        <x-input.text type="text"
                                            ...
                                            :value="old('title', $data->title)" name="title" placeholder="Title" required />
                                        @error('title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-input.text type="text"
                                            ...
                                            :value="old('summary', $data->summary)" name="summary" placeholder="Summary" required />
                                        @error('summary')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control @error('description') error-message @enderror"
                                            aria-label="With textarea">{{ old('description', $data->description) }}</textarea>
                                        @error('description')
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-6">
                                            ...
                                            <x-input.text type="text"
                                                class="form-control @error('quote') error-message @enderror" id="quote"
                                                :value="old('quote', $data->quote)" name="quote" placeholder="Quote" required />
                                            @error('quote')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select data-live-search="true" name="article_cat_id"
                                            class="form-control selectpicker @error('article_cat_id')error-message @enderror"
                                            id="simple-select2">
                                            <option value="">Select </option>
                                            @foreach ($categories as $role)
                                                <option value="{{ $role->id }}"
                                                    @if (isset($data)) @selected($data->article_cat_id == $role->id)  @endif>
                                                    {{ $role->name }}</option>
                                            @endforeach
                                          </optgroup>
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        <div id="existing-images-container" class="mb-4">
                                            <x-input.label for="existing_photos[]">Photos</x-input.label>
                                                ...
                                                <div class="input-group custom-input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button type="button" class="btn btn-danger"
                                                            onclick="removeExistingImage(this, '{{ $photo }}')">Remove</button>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="new_photo"
