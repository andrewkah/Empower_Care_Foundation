...
<section class="main-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="image-layer"
                    style="background-image: url(assets/images/slider/slider-v1-img-1.jpg);">
                </div>
                ...
                <div class="container">
                    <div class="main-slider-content">
                        <div class="main-slider-content__inner">
                            ...
                            <div class="btn-box">
                                <a href="donation-details.html" class="thm-btn">
                                    Donate Now
                                    <span>
            ...
            <div class="swiper-slide">
                <div class="image-layer"
                    style="background-image: url(assets/images/slider/slider-v1-img-2.jpg);">
                </div>
                <div class="image-layer__left-gradient"
                    style="background-image: url(assets/images/shapes/slider-bg1.jpg);"></div>
                <div class="container">
            ...
            <div class="swiper-slide">
                <div class="image-layer"
                    style="background-image: url(assets/images/slider/slider-v1-img-3.jpg);">
                </div>
                <div class="image-layer__left-gradient"
                    style="background-image: url(assets/images/shapes/slider-bg1.jpg);"></div>
                <div class="container">
    ...
    <ul class="banner-slider-nav-four">
        <li class="banner-slider-control-four banner-slider-button-prev" tabindex="0"
                    ...
                    <div class="welcome-one__content">
                        <div class="section-title text-left sec-title-animation animation-style2">
                            <div class="section-title__tagline-box">
                                <span class="section-title__tagline">Welcome To Anity</span>
                            </div>
    ...
    <div class="container">
        <div class="cta-one__inner">
            ...
            <div class="cta-one__btn-box">
                <a href="donation-details.html" class="cta-one__btn-1 thm-btn">Donate Now<span><i
                            class="icon-arrow-right"></i></span></a>
