...
@section('content')
    <!--Page Header Start-->
    <x-website-page-header title="Sponsors" bgImage="assets/images/backgrounds/page-header-bg.jpg"
        homeLink="{{ url('/') }}" />
    <!--Page Header End-->
            ...
            <div class="volunteer-carousel-style owl-carousel owl-theme carousel-dot-style">
                ...
                <div class="item">
                    <div class="team-one__single">
                        ...
                        <div class="team-one__content">
                            <div class="team-one__name-box">
                                <h4 class="team-one__name"><a href="volunteer-details.html">Marvin McKinney</a>
                                </h4>
                                <p class="team-one__sub-title">Dog Trainer</p>
                            </div>
                            <div class="team-one__share-and-social">
                                <div class="team-one__social">
                                    <a href="volunteer-details.html"><span class="icon-facebook"></span></a>
                ...
                <div class="item">
                    <div class="team-one__single">
                        ...
                        <div class="team-one__content">
                            <div class="team-one__name-box">
                                <h4 class="team-one__name"><a href="volunteer-details.html">Ronald Richards</a>
                                </h4>
                                <p class="team-one__sub-title">President of Sales</p>
                            </div>
                            <div class="team-one__share-and-social">
                                <div class="team-one__social">
                                    <a href="volunteer-details.html"><span class="icon-facebook"></span></a>
                ...
                <div class="item">
                    <div class="team-one__single">
                        ...
                        <div class="team-one__content">
                            <div class="team-one__name-box">
                                <h4 class="team-one__name"><a href="volunteer-details.html">Kathryn Murphy</a>
                                </h4>
                                <p class="team-one__sub-title">Medical Assistant</p>
                            </div>
                            <div class="team-one__share-and-social">
                                <div class="team-one__social">
                                    <a href="volunteer-details.html"><span class="icon-facebook"></span></a>
