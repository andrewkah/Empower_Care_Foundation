...
@section('content')
    ...
    <x-flash/>
        ...
        <section class="become-volinteer">
            <div class="container">
                <div class="become-volinteer__bottom">
                    <div class="row">
                    ...
                    <div class="become-volinteer__bottom-left">
                        <form class="" action="{{route('volunteer.request')}}"
                            method="post" >
                            @csrf 
                            <div class="row">
                                <div class="col-xl-6 col-lg-6">
                                    <div class="col-xl-12">
                                        <div class="become-volinteer__input-box">
                                            <input type="text" name="name" placeholder="Names" required="" value="{{old('name')}}">
                                            @error('name')
                                    ...
                                    <div class="col-xl-12">
                                        <div class="become-volinteer__input-box">
                                            <textarea name="bio" placeholder="Write your bio ...">{{old('bio')}}</textarea>
                                            @error('bio')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                        </div>
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="become-volinteer__input-box text-message-box">
                                        <textarea name="way_to_volunteer" placeholder="Write a short message, why you want to become a volunteer..">{{old('way_to_volunteer')}}</textarea>
                                        @error('way_to_volunteer')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                    </div>
                                </div>
